...
static void callback_friendmessage(Tox *, int, uint8_t*, uint16_t, tox_jni_globals_t*);
static void callback_action(Tox *, int, uint8_t*, uint16_t, tox_jni_globals_t*);
static void callback_namechange(Tox *, int, uint8_t*, uint16_t, tox_jni_globals_t*);
static void callback_statusmessage(Tox *, int, uint8_t*, uint16_t, tox_jni_globals_t*);
